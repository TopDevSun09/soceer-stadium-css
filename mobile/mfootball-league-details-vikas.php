<div class="league-details">
     <div class="league-details-header">
         ...
         <div class="league-details-title">
            <div class="league-image">
                <img src="/includes/mvc-theme/mobile/wc.a8livetv.com/images/uefa.jpeg" />
    ...
    <div id="Overview" class="tabcontent" style="display:block;">
        <div class="league-progress">
            ...
            <div class="progress-container mobile-container">
               ...
               <progress style="width: 80%; display:block; margin: auto; position: relative;top: 10px;" value="32" max="100">32%</progress>
        ...
        <div class="featured-match">
            <div class="featured-container">
               ...
               <div class="featured-club">
                    <div class="club-left" >
                      <img src="/includes/mvc-theme/mobile/wc.a8livetv.com/images/bayern.jpeg" />
                      <span>Bayern Munchen</span>
                    </div>
                    <div class="club-center" >
                        <span>10/5/22 0:45</span>
                        <div class="vs">
                             VS
                        </div>
                    </div>
                    <div class="club-right" >
                      <img src="/includes/mvc-theme/mobile/wc.a8livetv.com/images/viktoria.gif" />
                      <span>FC Viktoria Plzen</span>
                    </div>
        ...
        <div class="champions">
           <div class="champions-container">
                <div class="champions-title">
                   <span>Champions</span>
                </div>

                <img src="/includes/mvc-theme/mobile/wc.a8livetv.com/images/no-logo.svg" />
                <span id="title-num">Most titles (0)</span>
        ...
        <div class="league-info">
             <div class="league-info-container">
                 ...
                 <progress style="width: 90%; display:block; margin: auto; position: relative;top: 10px;" value="32" max="100">32%</progress>
