    ...
    <div class="panel_right" >
        ...
        <div class="home_date">
          ...
          <style>
            .dateBox { padding: 6px 8px; font-size: 65%; line-height: 13px; margin: 0px 2px 0px 0px; text-align: center;width:  100px; height:  35px; font-weight: medium; background: white;   border-top-left-radius:6px; border-top-right-radius:6px; float: left; cursor: pointer; font-weight: bold;}
            .dateBoxSelected { color: #f39c12; font-weight: bold; }
            .dateBox:hover {color:  #f1c40f;}
            .filter_dropdown {
              float: right;background: #95a5a6; border: 1px solid #95a5a6; font-size: 10px; text-align: center;width: 100px; border-radius:4px; padding: 4px 4px; margin-left: 10px; margin-top: 6px;color: white;font-weight: bold;
            }
          </style>
        ...
        <div class="home_schedule">
            ...
            <style >
              ...
              .football_league_matches_row_time{
                margin-left:10px;float:left;width:60px;
              }
              ...
              .football_league_matches_row_home{
                margin-left:10px;float:left;width:220px;
                text-align: right;
              }
              ...
              .football_league_matches_row_score{
                margin-left:10px;float:left;width:40px;
              ...
              .football_league_matches_row_corner{
                margin-left:10px;float:left;width:60px; 
                border: 1px solid transparent;
              }
              ...
              .cardRed{
                padding: 2px 3px; font-size: 80%;color: white; background: #eb3b5a;   border-radius: 2px;
              }
              .cardYellow{
                padding: 2px 3px; font-size: 80%;color: white; background: #fed330;   border-radius: 2px;
              }
              .hideData{
                display: none;
              }
              .football_league_matches_row_now_playing {
                font-weight: bold;
                color: red;
              }
            </style>
            ...
            switch($_GET['filterLive']){
                case "LIVE":
                    //$extSql .= " AND lml.TimeStart < NOW() AND lml.TimeStop > NOW() ";
                    $extSql .= " AND lml.NowPlaying = '1' ";
                    break;
                case "END":
                    $extSql .= " AND lml.TimeStop < NOW() ";
                    break;
            }
            ...
            if(tep_num_rows($qryRow)!=0){
                ...
                while($infoRow = tep_fetch_object($qryRow)){
                  ...
                  // NOW PLAYING AND BLINKING 
                  // NOW PLAYING AND BLINKING 
                  if( $infoRow->NowPlaying == "1" || strpos($matchProgressTime,"'") > 0 ){
                      $strNowPlaying = "football_league_matches_row_now_playing";
                      $homeScore = "color:red;";
                      $awayScore = "color:red;";
                  } else {
                      $strNowPlaying = "";
                  ...
                  echo "
                  <div class=\"football_league_matches_row\" match-id=\"".$infoRow->match_id."\" onclick=\"window.location='football-live?id=".createToken($infoRow->match_id)."'\">
                    
                    <div class=\"football_league_matches_row_time\">
                      ".date('H:i:s',strtotime($infoRow->match_time))." 
                    </div>

                    <div class=\"football_league_matches_row_status {$strNowPlaying}\">
                      ".$matchProgressTime."
                    </div>
                    ...
                    <div class=\"football_league_matches_row_score {$strNowPlaying}\">
                      <div class=\"{$hideData}\">
                    ...
                    <div class=\"football_league_matches_row_corner \">
                        <div class=\"{$hideData}\">
