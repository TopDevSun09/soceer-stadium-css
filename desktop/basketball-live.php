...
.first_bar span a{font-weight: 400;padding-bottom: 10px;display: inline-block;border-bottom:2px solid transparent;}
...
.width-250{width:370px;color: gray;white-space: nowrap;}
...
.title-section{color: #fff;text-align: left;font-weight: normal;padding: 8px 15px;background:linear-gradient(300deg, rgb(211 169 37) 35%, rgb(135 107 17) 100%);font-size:14px;font-weight:400}
.score_frame table th {background: #f7f3e7;border: 1px solid #f7f3e7;border-bottom: 1px solid #d9d9d9;}
...
.show-play-by-play-quarter2{overflow:hidden;}
.show-play-by-play-quarter2 div{float:left;text-align:center;padding: 12px 20px;font-size:12px;border: 0.2px solid #d9d9d94d;}
.show-play-by-play-quarter2 .col-sm-8{text-align: left;}
.show-play-by-play-quarter3{overflow:hidden;}
.show-play-by-play-quarter3 div{float:left;text-align:center;padding: 12px 20px;font-size:12px;border: 0.2px solid #d9d9d94d;}
.show-play-by-play-quarter3 .col-sm-8{text-align: left;}
.show-play-by-play-quarter4{overflow:hidden;}
.show-play-by-play-quarter4 div{float:left;text-align:center;padding: 12px 20px;font-size:12px;border: 0.2px solid #d9d9d94d;}
.show-play-by-play-quarter4 .col-sm-8{text-align: left;}
.btn-quarter-play-by-play.current{background: linear-gradient(300deg, rgb(211 169 37) 35%, rgb(135 107 17) 100%);color:#fff;font-weight:bold;}
.first_bar span.current a {color: #000;border-bottom: 2px solid #000;}
.first_bar span a:hover {color: #000;border-bottom: 2px solid #000;}
.details_team + .first_bar{padding-bottom: 0px;}
.tableShowData + span {padding: 20px 0px 0px 0px;display: block;text-align: left;}
.span-adjust + span{padding: 20px 0px 0px 0px;display: block;text-align: left;}
.col-show-standing.numbr-only{width:50px;}
.table-show-h2h .thShowData .col-show-h2h-title{background: #f7f3e7;border: 1px solid #f7f3e7;border-bottom: 1px solid #d9d9d9;padding: 7px;}
.table-show-h2h .thShowData .col-show-h2h{background: #f7f3e7;border: 1px solid #f7f3e7;border-bottom: 1px solid #d9d9d9;padding: 7px;}
.progress{height: 0.5rem;}
.progress .bg-success{background-color: #2dadef!important;}
.progress .bg-info{background-color: #f5c35f!important;}
.show-row-match-stat {font-size: 14px;margin: 0px 0px;padding: 0px 15px 16px 15px;}
        ...
        <div class="first_bar">
          <?php
                ...
                $strTab = '<span ><a href="basketball-live?tab=BOXSCORE&id='.createToken($infoRow->match_id).'">Box Score</a></span>
                           ...
                           <span class="current"><a href="basketball-live?tab=LIVE&id='.createToken($infoRow->match_id).'">Live</a></span>';
        ...
        <div class="details_container">
            ...
            ?>
              ...
              <div class="details_left">
                ...
                ?>
                    <iframe src="<?php echo $live->H5LINKROW; ?>" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" height = "500" width = "800" ></iframe>
                ...
                ?>
                  ...
                  <center>
                      ...
                      <div class="video-wrap">
                        <div style="position: relative; background: url('includes/images/basketball-background.png') no-repeat center center;width: 100%;height: 100%;">
                  ...
                  <?php
                    ...
                    if(tep_num_rows($qryState) == 0)
                    {
                      $totalShootHitHome = 0;
                      $totalShootHome = 0;
                      $totalThreePointHitHome = 0;
                      $totalThreePointShootHome = 0;
                      $totalFreeThrowHitHome = 0;
                      $totalFreeThrowShootHome = 0;
                      $totalOffensiveReboundHome = 0;
                      $totalDefensiveReboundHome = 0;
                      $totalAssistHome = 0;
                      $totalFoulHome = 0;
                      $totalStealHome = 0;
                      $totalTurnoverHome = 0;
                      ...
                      $percentageThreePointHome = 0;
                      $percentageFieldGoalHome = 0;
                      $percentageFreeThrowHome = 0;
                      ...
                      $totalShootHitAway = 0;
                      $totalShootAway = 0;
                      $totalThreePointHitAway = 0;
                      $totalThreePointShootAway = 0;
                      $totalFreeThrowHitAway = 0;
                      $totalFreeThrowShootAway = 0;
                      $totalOffensiveReboundAway = 0;
                      $totalDefensiveReboundAway = 0;
                      $totalAssistAway = 0;
                      $totalFoulAway = 0;
                      $totalStealAway = 0;
                      $totalTurnoverAway = 0;
                      ...
                      $percentageThreePointAway = 0;
                      $percentageFieldGoalAway = 0;
                      $percentageFreeThrowAway = 0;
                    ...
                    else
                    {
                      ...
                      $widthShootHome = ($totalShootHome / ($totalShootHome + $totalShootAway)) * 100;
                      $widthShootAway = ($totalShootAway / ($totalShootHome + $totalShootAway)) * 100;

                      $widthFieldGoalHome = ($percentageFieldGoalHome / ($percentageFieldGoalHome + $percentageFieldGoalAway)) * 100;
                      $widthFieldGoalAway = ($percentageFieldGoalAway / ($percentageFieldGoalHome + $percentageFieldGoalAway)) * 100;

                      $widthThreePointShootHome = ($totalThreePointShootHome / ($totalThreePointShootHome + $totalThreePointShootAway)) * 100;
                      $widthThreePointShootAway = ($totalThreePointShootAway / ($totalThreePointShootHome + $totalThreePointShootAway)) * 100;

                      $widthPercentageThreePointHome = ($percentageThreePointHome / ($percentageThreePointHome + $percentageThreePointAway)) * 100;
                      $widthPercentageThreePointAway = ($percentageThreePointAway / ($percentageThreePointHome + $percentageThreePointAway)) * 100;

                      $widthFreeThrowShootHome = ($totalFreeThrowShootHome / ($totalFreeThrowShootHome + $totalFreeThrowShootAway)) * 100;
                      $widthFreeThrowShootAway = ($totalFreeThrowShootAway / ($totalFreeThrowShootHome + $totalFreeThrowShootAway)) * 100;

                      $widthFreeThrowHome = ($percentageFreeThrowHome / ($percentageFreeThrowHome + $percentageFreeThrowAway)) * 100;
                      $widthFreeThrowAway = ($percentageFreeThrowAway / ($percentageFreeThrowHome + $percentageFreeThrowAway)) * 100;

                      $widthReboundsHome = ($reboundsHome / ($reboundsHome + $reboundsAway)) * 100;
                      $widthReboundsAway = ($reboundsAway / ($reboundsHome + $reboundsAway)) * 100;

                      $widthAssistHome = ($totalAssistHome / ($totalAssistHome + $reboundsAway)) * 100;
                      $widthAssistAway = ($totalAssistAway / ($totalAssistHome + $reboundsAway)) * 100;

                      $widthFoulHome = ($totalFoulHome / ($totalFoulHome + $totalFoulAway)) * 100;
                      $widthFoulAway = ($totalFoulAway / ($totalFoulHome + $totalFoulAway)) * 100;
                    }
                  ?>
                  ...
                  <div class="attacks">
                        ...
                        <div class="shoot-content">
                          ...
                          <div class="row-block">
                            ...
                            <div class="process-box">
                              <span class="absolute right-fix"><?php echo round($percentageFieldGoalAway, 2); ?></span>
                            </div>
                          </div>
                          <!-- Free Throws -->
                          <div class="row-block">
                            ...
                            <div class="process-box">
                              <span class="absolute right-fix"><?php echo round($percentageFreeThrowAway, 2); ?></span>
                            </div>
                          </div>
                ...
                <div class="section-play-by-play">
                  ...
                  if($list){
                    ...
                    <div class="quarter-btn-group">
                      <div class="btn-quarter-play-by-play current" id="btn-quarter-1-play-by-play" type="button">Q1</div>
                    ...
                    foreach($list as $arrList)
                    {
                        echo '<div class="row show-play-by-play-quarter'.$arrList->matchState.' ">
                                <div class="col-sm-2 text-center">'.$arrList->remainTime.'</div>
                                <div class="col-sm-8">'.$arrList->content.'</div>
                                <div class="col-sm-2 text-center">'.$arrList->score.'</div>
                              </div>';
                    }
                  ?>
                      </table>
                ...
                <script type="text/javascript">
                  ...
                  $('.quarter-btn-group .btn-quarter-play-by-play').on('click', function(){
                      $('.quarter-btn-group .btn-quarter-play-by-play.current').removeClass('current');
                      $(this).addClass('current');
                  });



                  $('.first_bar span').on('click', function(){
                      $('.first_bar span.current').removeClass('current');
                      $(this).addClass('current');
                  });
                  ...
                  $('.boxy .btn-quarter-play-by-play').on('click', function(){
                      $('.boxy .btn-quarter-play-by-play.current').removeClass('current');
                      $(this).addClass('current');
                  });
                </script>
              ...
              <div>
                ...
                <?php
                  ...
                  if(tep_num_rows($qryTopPlayer) == 0)
                  {
                    $homePlayerLogoPoints = "includes/images/user-no-data-icon.png";
                 
                    $awayPlayerLogoPoints = "includes/images/user-no-data-icon.png";

                    $homePlayerLogoAssist = "includes/images/user-no-data-icon.png";
                  
                    $awayPlayerLogoAssist = "includes/images/user-no-data-icon.png";
                  
                    $homePlayerLogoRebound = "includes/images/user-no-data-icon.png";
                  
                    $awayPlayerLogoRebound = "includes/images/user-no-data-icon.png";
                  }
                  ...
                  else
                  {
                    while($infoTopPlayer = tep_fetch_object($qryTopPlayer))
                    {
                      ...
                      if($infoTopPlayer->type == 'HOME')
                      {
                        ...
                        $infoPointsHome = tep_fetch_object(tep_query("SELECT * FROM nano_basketball_match_statistic WHERE matchId = '".$infoRow->match_code."' AND type = 'HOME' ORDER BY score DESC LIMIT 0,1"));
                        
                        $infoAssistHome = tep_fetch_object(tep_query("SELECT * FROM nano_basketball_match_statistic WHERE matchId = '".$infoRow->match_code."' AND type = 'HOME' ORDER BY assist DESC LIMIT 0,1"));
                      ...
                      {
                        $infoPointsAway = tep_fetch_object(tep_query("SELECT * FROM nano_basketball_match_statistic WHERE matchId = '".$infoRow->match_code."' AND type = 'AWAY' ORDER BY score DESC LIMIT 0,1"));

                        $infoAssistAway = tep_fetch_object(tep_query("SELECT * FROM nano_basketball_match_statistic WHERE matchId = '".$infoRow->match_code."' AND type = 'AWAY' ORDER BY assist DESC LIMIT 0,1"));
                ...
                <div class="body-stats">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="progress justify-content-end">
                          <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $widthShootHome; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>

                      <div class="col-sm-6">
                        <div class="progress">
                            <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo $widthShootAway; ?>%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="show-row-match-stat">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="progress justify-content-end">
                          <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $widthFieldGoalHome; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>

                      <div class="col-sm-6">
                        <div class="progress">
                          <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo $widthFieldGoalAway; ?>%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="show-row-match-stat">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="progress justify-content-end">
                          <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $widthThreePointShootHome; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>

                      <div class="col-sm-6">
                        <div class="progress">
                          <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo $widthThreePointShootAway; ?>%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="show-row-match-stat">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="progress justify-content-end">
                          <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $widthPercentageThreePointHome; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>

                      <div class="col-sm-6">
                        <div class="progress">
                          <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo $widthPercentageThreePointHome; ?>%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="show-row-match-stat">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="progress justify-content-end">
                          <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $widthFreeThrowShootHome; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>

                      <div class="col-sm-6">
                        <div class="progress">
                          <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo $widthFreeThrowShootAway; ?>%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="show-row-match-stat">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="progress justify-content-end">
                          <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $widthFreeThrowHome; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>

                      <div class="col-sm-6">
                        <div class="progress">
                          <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo $widthFreeThrowAway; ?>%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="show-row-match-stat">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="progress justify-content-end">
                          <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $widthReboundsHome; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>

                      <div class="col-sm-6">
                        <div class="progress">
                          <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo $widthReboundsAway; ?>%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="show-row-match-stat">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="progress justify-content-end">
                          <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $widthAssistHome; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>

                      <div class="col-sm-6">
                        <div class="progress">
                          <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo $widthAssistAway; ?>%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="show-row-match-stat">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="progress justify-content-end">
                          <div class="progress-bar bg-success" role="progressbar" style="width: <?php echo $widthFoulHome; ?>%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>

                      <div class="col-sm-6">
                        <div class="progress">
                          <div class="progress-bar bg-info" role="progressbar" style="width: <?php echo $widthFoulAway; ?>%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="showData">
              <div class="first_bar title-section span-adjust">
                Standing
              </div>
                ...
                if($standingLeague)
                {
                  echo '<table class="tableShowData">
                          <thead class="thShowData">
                            <td class="col-show-standing numbr-only">#</td>
                            <td class="col-show-standing text-left">Team</td>
                  ...
                  {
                    echo '<tr>
                            <td class="col-show-standing numbr-only">'.$arrStandingLeague['rank'].'</td>
                            <td class="col-show-standing text-left">'.$arrStandingLeague['teamname'].'</td>
                ...
                else if($standingCup)
                {
                    ...
                    for($i = 0; $i < sizeof($arrGroup); $i++)
                    {
                      ...
                      foreach($standingCup as $arrStandingCup)
                      {
                        ...
                        {
                          echo '<tr>
                                  <td class="col-show-standing numbr-only">'.$arrStandingCup['rank'].'</td>
                                  <td class="col-show-standing text-left">'.$arrStandingCup['teamname'].'</td>
                ...
                else if($standingConference)
                {
                  ...
                  for($i = 0; $i < sizeof($arrConference); $i++)
                  {
                    ...
                    foreach($conference as $arrStandingConference)
                    {
                      ...
                      {
                        echo '<tr>
                                <td class="col-show-standing numbr-only">'.$arrStandingConference['rank'].'</td>
                                <td class="col-show-standing text-left">'.$arrStandingConference['teamname'].'</td>
                  ...
                  for($i = 0; $i < sizeof($arrDivision); $i++)
                  {
                    ...
                    foreach($division as $arrStandingDivision)
                    {
                      ...
                      {
                        echo '<tr>
                                <td class="col-show-standing numbr-only">'.$arrStandingDivision['rank'].'</td>
                                <td class="col-show-standing text-left">'.$arrStandingDivision['teamname'].'</td>
              ...
              <div class="showData">
                <div class="title-section">
                  BOX SCORE
                    ...
                    <div class="quarter-btn-group boxy">
                      <div class="btn-quarter-play-by-play current" id="btn-box-score-all" type="button">All</div>
                      <div class="btn-quarter-play-by-play" id="btn-box-score-home" type="button">Home</div>
                      <div class="btn-quarter-play-by-play" id="btn-box-score-away" type="button">Away</div>
                    </div>
                ...
                <?php
                  ...
                  $qryStatistic = tep_query("SELECT * FROM nano_basketball_match_statistic WHERE matchId = '".$infoRow->match_code."' ");

                  $infoMatch = tep_fetch_object(tep_query("SELECT * FROM nano_basketball_schedule_match WHERE match_code = '".$infoRow->match_code."' "));
