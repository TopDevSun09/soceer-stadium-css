...
?>
	...
	<style>
		...
		.item-right {
			...
			top: 0.52083rem;
			left: 50%;
			padding: 0.67708rem 0.41667rem;
			margin-left: 2.1875rem;
			min-width: 8.95833rem;
			max-width: 50%;
			background: #fcfcfc;
			border: 0.10417rem solid #999999;
			padding: 0.26042rem 0.41667rem;
			font-size: 0.72917rem;
			font-weight: 500;
			color: #333333;
			-webkit-transform: rotateX(5.20833rem);
			transform: rotateX(5.20833rem);
			opacity: 0;
		...
		.item-right::before {
			...
			transform: scale(0.5);
			border-width: 0.78125rem 1.04167rem;
			border-style: solid;
			left: -1.5625rem;
			top: 0;
			z-index: 2;
		...
		.assists>ul {
			...
			width: 48.95833rem;
			margin: 0 auto;
			padding: 0.78125rem 1.04167rem 0 1.71875rem;
			-ms-flex-line-pack: start;
			align-content: flex-start;
		}
		.assists>ul>li {	
			font-weight: normal !important;
			font-size: 0.78542rem !important;
			display: -webkit-box;
			display: -ms-flexbox;
			display: flex;
			-webkit-box-align: center;
        ...
        ?>
            <div class="details_left">
				...
				<div class="panel">
						...
						<div>
							<ul class="timelist">
								<?php
									...
									$qryTechnicalStatistic = tep_query("SELECT * FROM nano_football_technical_statistic WHERE statistic_matchId = '".tep_input($infoRow->match_code)."' ORDER BY statistic_time ASC");
								...
								?>
										<li class='item'>
											...
											<div class = "<?php echo $class; ?>" style = "transform: translateX(0px); opacity: 1;">
												<?php
													$kind = $infoTechnicalStatistic->statistic_kind;
													if ($kind == "Yellow card"):
												?>
													<div>
														<span><?php echo $infoTechnicalStatistic->statistic_nameEn?></span>
														<div class="icon-img">
												...
												?>
													<div>
														<span><?php echo substr($infoTechnicalStatistic->statistic_nameEn, 0, strpos($infoTechnicalStatistic->statistic_nameEn, "Assist") - 1);?></span>
														<div class="icon-img">
															<img src="https://www.a8livetv.com/themes/a8livetv/image/goals.png" alt>
														</div>
													</div>
													<div>
														<span><?php echo trim(substr($infoTechnicalStatistic->statistic_nameEn, strpos($infoTechnicalStatistic->statistic_nameEn, "Assist") + 7), ")");?></span>
														<div class="icon-img">
															<img src="https://www.a8livetv.com/themes/a8livetv/image/assist.png" alt>
														</div>
													</div>
													<?php
														elseif ($kind == "Sub"):
													?>
														<div>
															<span><?php echo substr($infoTechnicalStatistic->statistic_nameEn, 0, strpos($infoTechnicalStatistic->statistic_nameEn, "↑") - 1);?></span>
															<div class="icon-img">
														...
														<div>
															<span><?php echo trim(substr($infoTechnicalStatistic->statistic_nameEn, strpos($infoTechnicalStatistic->statistic_nameEn, "↑") + 3), "↓");?></span>
															<div class="icon-img">
																<img src="data:image/svg+xml;base64," alt>
															</div>
														</div>
					...
					<div class="assists"><p>Figure Legends:</p> 
					<ul>
						...
						<li><img src="data:image/svg+xml;base64," alt="">Yellow card</li> 
						<li><img src="data:image/svg+xml;base64," alt="">Red card</li> <li><img src="https://www.a8livetv.com/assets/589c34ad1e1c68c1bebaba09b921d815.svg" alt="">Second Yellow</li> 
						<li><img src="data:image/svg+xml;base64," alt="">Substitution</li> 
						<li><img src="https://www.a8livetv.com/assets/GoalCancelled.svg" alt="">Goal Cancelled</li></ul></div>
				</div>
				<style>
					.panel{
						border-radius: 6px;
