    ...
    <div class="panel_right" >
        ...
        <div class="home_schedule">
            ...
            switch($_GET['filterLive']){
                case "LIVE":
                    // $extSql .= " AND blm.TimeStart < NOW() AND blm.TimeStop > NOW() ";
            ...
            if(tep_num_rows($qryRow)!=0){
                ...
                while($infoRow = tep_fetch_object($qryRow)){
                  ...
                  // if($infoRow->match_state == 'The first quarter' || $infoRow->match_state == 'The second quarter' || $infoRow->match_state == 'The third quarter' || $infoRow->match_state == 'The fourth quarter')
                  // {
